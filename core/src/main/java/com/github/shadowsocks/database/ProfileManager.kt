...
//        Log.e("peace","createProfilesFromJson")
...
//        Log.e("peace","getProfile id=${id}")
//        throw RuntimeException("hhhhpeace")
        PrivateDatabase.profileDao[id]
    } catch (ex: SQLiteCantOpenDatabaseException) {
//        Log.e("peace","getProfile ex=${ex.message}")
        throw IOException(ex)
    } catch (ex: SQLException) {
//        Log.e("peace","SQLException ex=${ex.message}")
        Timber.w(ex)
        null
    }
